...
# ADDITIONAL TEST CASES #
  ...
  test "deal_6" do 
    t6 = [2,2,2,2,4,4,4,4,6,6,6,6,8,8,8,8,10,10,10,10,12,12,12,12,1,1,1,1,3,3,3,3,5,5,5,5,7,7,7,7,9,9,9,9,11,11,11,11,13,13,13,13]  
    r6 = [2,1,1,1,1,13,13,13,13,12,12,12,12,11,11,11,11,10,10,10,10,9,9,9,9,8,8,8,8,7,7,7,7,6,6,6,6,5,5,5,5,4,4,4,4,3,3,3,3,2,2,2]
    assert War.deal(t6) == r6
  end
  
  test "deal_7" do
    t7 = [4,4,4,4,6,6,6,6,3,3,3,3,9,9,9,9,10,10,10,10,11,11,11,11,12,12,12,12,1,1,1,1,7,7,7,7,8,8,8,8,13,13,13,13,2,2,2,2,5,5,5,5]  
    r7 = [4,1,1,1,1,13,13,13,13,12,12,12,12,11,11,11,11,10,10,10,10,9,9,9,9,8,8,8,8,7,7,7,7,6,6,6,6,5,5,5,5,4,4,4,3,3,3,3,2,2,2,2]
    assert War.deal(t7) == r7
  end
  
  test "deal_8" do
    t8 = [2,2,4,4,6,6,8,8,10,10,12,12,1,1,3,3,5,5,7,7,9,9,11,11,13,13,2,2,4,4,6,6,8,8,10,10,12,12,1,1,3,3,5,5,7,7,9,9,11,11,13,13]  
    r8 = [2,1,1,1,1,13,13,13,13,12,12,12,12,11,11,11,11,10,10,10,10,9,9,9,9,8,8,8,8,7,7,7,7,6,6,6,6,5,5,5,5,4,4,4,4,3,3,3,3,2,2,2]
    assert War.deal(t8) == r8
  end

  test "deal_9" do
    t9 = [7,7,7,7,4,4,4,4,2,2,2,2,11,11,11,11,10,10,10,10,9,9,9,9,8,8,8,8,13,13,13,13,12,12,12,12,6,6,6,6,5,5,5,5,3,3,3,3,1,1,1,1]  
    r9 = [7,1,1,1,1,13,13,13,13,12,12,12,12,11,11,11,11,10,10,10,10,9,9,9,9,8,8,8,8,7,7,7,6,6,6,6,5,5,5,5,4,4,4,4,3,3,3,3,2,2,2,2]
    assert War.deal(t9) == r9
  end 

  test "deal_10" do
    t10 = [9,9,9,9,8,8,8,8,13,13,13,13,12,12,12,12,1,1,1,1,7,7,7,7,4,4,4,4,2,2,2,2,11,11,11,11,10,10,10,10,6,6,6,6,5,5,5,5,3,3,3,3]  
    r10 = [9,1,1,1,1,13,13,13,13,12,12,12,12,11,11,11,11,10,10,10,10,9,9,9,8,8,8,8,7,7,7,7,6,6,6,6,5,5,5,5,4,4,4,4,3,3,3,3,2,2,2,2]
